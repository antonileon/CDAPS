...
?>
    <section class="content-header">
      <h1>Consultas<small>Beneficiar Persona</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li><a href="#"></a>Consultas</li>
        <li class="active">Beneficiar Persona</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#datosPersonales" data-toggle="tab"><i class="fa fa-undo"></i> Beneficiar Persona</a></li>
            </ul>
            <div class="tab-content">
              <div class="active tab-pane" id="datosPersonales">
                <form class="form-horizontal" action="index.php?llave=beneficiar_persona" method="POST" id="insumos">
                  ...
                  <div class="col-sm-12">
                    ...
                    <textarea class="form-control" placeholder="Motivos de Beneficiarlo" style="resize:none;" name="motivo_beneficiar" id="motivo_beneficiar" required></textarea>
                  </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-5 col-sm-7">
                      <a href="index.php?llave=listado_inhabilitado" class="btn btn-default">Regresar... <i class="ion-ios-undo"></i></a>
                      <button type="submit" class="btn btn-success" id="submit_btn" data-loading-text="Cambiando Datos....">Beneficiar Persona <i class="fa fa-undo"></i></button>
                    </div>
                  </div>
                </form> 
              </div>
