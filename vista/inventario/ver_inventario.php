<?php 
  ...
  $sq= "SELECT * FROM inventario te
  INNER JOIN insumos tei ON te.id_insumos=tei.id_insumos
  INNER JOIN proveedores pro ON tei.id_proveedores=pro.id_proveedores
  WHERE te.id_inventario='$id_inventario'";
...
?>
	<section class="content-header">
      <h1>Consultas<small>Ver Productos registrado</small></h1>
      <ol class="breadcrumb">
