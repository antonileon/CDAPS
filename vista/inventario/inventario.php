<?php
  ...
  $sql5= "SELECT * FROM inventario INNER JOIN insumos 
  ON insumos.id_insumos = inventario.id_insumos WHERE inventario.estado='Aceptado' Order by id_inventario DESC";
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                    <?php
                      echo '<td>'.mb_convert_encoding($row['codigo_insumo'], "UTF-8").'</td>';
                      ...
                      echo '<td>'.mb_convert_encoding($row['marca'], "UTF-8").'</td>';
